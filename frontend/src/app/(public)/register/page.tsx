...
export default function Register() {
    ...
    async function getFormData() {
        ...
        try {
            ...
            console.error(err);
            setMessage("Houve um erro interno. Tente novamente...");
        }
    }
    ...
    return (
        <div>
            ...
            <Alert variant="destructive" hidden={!isMessageVisible} className="max-w-xl mx-auto mb-4 bg-neutral-100 text-red-800">
                <AlertCircleIcon/>
