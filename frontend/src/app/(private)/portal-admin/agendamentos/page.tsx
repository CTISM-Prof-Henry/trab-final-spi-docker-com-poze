...
export default function AgendamentosAdmin() {
    ...
    async function fetchAgendamentos() {
        setIsLoading(true);
        try {
            const response = await api.get<AgendamentoDTO[]>('/agendamento/find-all');
                            ...
                            <Table className="w-full">
                                <TableHeader className="bg-gradient-to-r from-purple-600 to-indigo-700">
                                    <TableRow className="border-none hover:bg-transparent">
                                        ...
                                        <TableHead className="text-white font-bold text-sm py-4 w-[180px]">
                                        ...
                                        >
                                            ...
                                            <TableCell className="py-4 border-r border-gray-100">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <span className="font-medium text-gray-800 block">{agendamento.user?.name}</span>
                                                        <span className="text-xs text-gray-500">{agendamento.user?.matricula}</span>
                                                    </div>
                                                </div>
                                            </TableCell>
                                            <TableCell className="py-4 border-r border-gray-100">
